...
export const week4: TrainingWeekDefinition = {
  ...
  days: [
    ...
    {
      name: "Mardi",
      objective: "Course d’endurance",
      title: "Cadence douce",
      priority: "Haute",
      tasks: [
        { id: "run-2", label: "Course — 8 km", type: "run", detail: "Allure régulière", xp: 50 },
    ...
    },
    {
      ...
      priority: "Normale",
      tasks: [
        { id: "swim-3", label: "Natation — 1500 m", type: "swim", detail: "Échauffement + technique", xp: 35 },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "run-4", label: "Course — 6 km fractionné", type: "run", detail: "40/20", xp: 50 },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "run-6", label: "Course — 13 km", type: "run", detail: "Allure confort", xp: 50 },
        { id: "swim-6", label: "Natation — 1100 m récup", type: "swim", detail: "Souple", xp: 35 },
