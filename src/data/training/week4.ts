  ...
  days: [
    {
      ...
      tasks: [
        ...
        { id: "w4-mon-pull", label: "Tractions (Séries Droites RIR 1-2) — 5 × 5 reps", type: "pull", moment: "morning", detail: "5 séries droites • RIR 1-2 • Repos strict 90s • Test RIR sur dernière série", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w4-mon-chair", label: "Chaise Isométrique — 3 × 90 s", type: "chair", moment: "morning", detail: "Maintien statique à 90° • Repos 60s", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w4-wed-pull", label: "Tractions (Séries Droites RIR 1-2) — 5 × 5 reps", type: "pull", moment: "morning", detail: "5 séries droites • RIR 1-2 • Repos strict 90s • Test RIR sur dernière série", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w4-wed-chair", label: "Chaise Isométrique — 3 × 90 s", type: "chair", moment: "morning", detail: "Maintien statique à 90° • Repos 60s", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w4-thu-pull", label: "Tractions (Pré-activation) — 4 × 3 reps", type: "pull", moment: "morning", detail: "Pré-activation sous-maximale sans échec (RIR 3-4)", estimatedMinutes: 12, xp: 20, completed: false },
        { id: "w4-thu-chair", label: "Chaise (Pré-activation) — 3 × 30 s", type: "chair", moment: "morning", detail: "Éveil statique léger sans échec", estimatedMinutes: 8, xp: 10, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w4-fri-pull", label: "Tractions (Séries Droites RIR 1-2) — 5 × 5 reps", type: "pull", moment: "morning", detail: "5 séries droites • RIR 1-2 • Repos strict 90s • Test RIR sur dernière série", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w4-fri-chair", label: "Chaise Isométrique — 3 × 90 s", type: "chair", moment: "morning", detail: "Maintien statique à 90° • Repos 60s", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w4-sat-core", label: "Gainage — 15 min", type: "custom", moment: "afternoon", detail: "Stabilité du tronc", estimatedMinutes: 15, xp: 15, completed: false },
