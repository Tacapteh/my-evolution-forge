...
export const week3: TrainingWeekDefinition = {
  ...
  days: [
    ...
    {
      name: "Mardi",
      objective: "Course de rythme",
      title: "Cadence douce",
      priority: "Haute",
      tasks: [
        { id: "run-2", label: "Course — 7 km", type: "run", detail: "Allure régulière", xp: 50 },
    ...
    {
      name: "Mercredi",
      objective: "Endurance aquatique",
      title: "Rythme fluide",
      priority: "Normale",
      tasks: [
        { id: "swim-3", label: "Natation — 1400 m", type: "swim", detail: "Échauffement + corps", xp: 35 },
    ...
    {
      name: "Jeudi",
      objective: "Équilibre et puissance",
      title: "Équilibre solide",
      priority: "Haute",
      tasks: [
        { id: "chair-4", label: "Chaise — 4 x 90s", type: "chair", detail: "Repos 60s", xp: 15 },
        { id: "run-4", label: "Course — 5 km fractionné", type: "run", detail: "30/30", xp: 50 },
    ...
    {
      name: "Samedi",
      objective: "Longue endurance",
      title: "Régularité",
      priority: "Haute",
      tasks: [
        { id: "run-6", label: "Course — 12 km", type: "run", detail: "Allure confort", xp: 50 },
        { id: "swim-6", label: "Natation — 1000 m récup", type: "swim", detail: "Souple", xp: 35 },
