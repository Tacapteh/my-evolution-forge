  ...
  days: [
    {
      ...
      tasks: [
        ...
        { id: "w8-mon-pull", label: "Tractions — volume réduit", type: "pull", moment: "morning", detail: "Post-piscine", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w8-mon-chair", label: "Chaise — 168 s", type: "chair", moment: "morning", detail: "Renforcement musculaire", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w8-tue-pull", label: "Tractions — 3 séries légères", type: "pull", moment: "morning", detail: "Matinée progressive", estimatedMinutes: 15, xp: 20, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w8-wed-pull", label: "Tractions — volume réduit", type: "pull", moment: "morning", detail: "Renforcement léger", estimatedMinutes: 15, xp: 20, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w8-thu-pull", label: "Tractions — volume réduit", type: "pull", moment: "morning", detail: "Renforcement léger", estimatedMinutes: 15, xp: 20, completed: false },
        { id: "w8-thu-chair", label: "Chaise — 168 s", type: "chair", moment: "morning", detail: "Stabilité", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w8-sat-pull", label: "Tractions — volume réduit", type: "pull", moment: "afternoon", detail: "Post-sortie", estimatedMinutes: 15, xp: 20, completed: false },
        { id: "w8-sat-chair", label: "Chaise — 168 s", type: "chair", moment: "afternoon", detail: "Renforcement", estimatedMinutes: 10, xp: 15, completed: false },
        { id: "w8-sat-core", label: "Gainage — 15 min", type: "custom", moment: "afternoon", detail: "Stabilité", estimatedMinutes: 15, xp: 15, completed: false },
