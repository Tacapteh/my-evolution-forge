  ...
  days: [
    {
      ...
      tasks: [
        ...
        { id: "w5-mon-pull", label: "Tractions — 5×6", type: "pull", moment: "morning", detail: "Post-piscine", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w5-mon-chair", label: "Chaise — 3×120 s", type: "chair", moment: "morning", detail: "Renforcement musculaire", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w5-tue-pull", label: "Tractions — 5 séries réparties", type: "pull", moment: "morning", detail: "Matinée progressive", estimatedMinutes: 20, xp: 25, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w5-wed-pull", label: "Tractions — 5×6", type: "pull", moment: "morning", detail: "Renforcement", estimatedMinutes: 15, xp: 25, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w5-thu-pull", label: "Tractions — 5×6", type: "pull", moment: "morning", detail: "Renforcement", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w5-thu-chair", label: "Chaise — 3×120 s", type: "chair", moment: "morning", detail: "Stabilité", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w5-sat-pull", label: "Tractions — 5×6", type: "pull", moment: "afternoon", detail: "Post-sortie", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w5-sat-chair", label: "Chaise — 3×120 s", type: "chair", moment: "afternoon", detail: "Renforcement", estimatedMinutes: 10, xp: 15, completed: false },
        { id: "w5-sat-core", label: "Gainage — 15 min", type: "custom", moment: "afternoon", detail: "Stabilité", estimatedMinutes: 15, xp: 15, completed: false },
