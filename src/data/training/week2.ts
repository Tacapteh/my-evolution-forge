...
export const week2: TrainingWeekDefinition = {
  ...
  days: [
    ...
    {
      name: "Mardi",
      objective: "Course de confort",
      title: "Économie de souffle",
      priority: "Haute",
      tasks: [
        { id: "run-2", label: "Course — 6 km", type: "run", detail: "Allure confortable", xp: 50 },
    ...
    },
    {
      ...
      priority: "Normale",
      tasks: [
        { id: "swim-3", label: "Natation — 1200 m", type: "swim", detail: "Échauffement + technique", xp: 35 },
    ...
    {
      name: "Jeudi",
      objective: "Vitesse et explosivité",
      title: "Équilibre solide",
      priority: "Haute",
      tasks: [
        { id: "chair-4", label: "Chaise — 4 x 90s", type: "chair", detail: "Repos 60s", xp: 15 },
        { id: "run-4", label: "Course — 4 km fractionné", type: "run", detail: "40/20", xp: 50 },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "run-6", label: "Course — 11 km", type: "run", detail: "Allure confort", xp: 50 },
        { id: "swim-6", label: "Natation — 900 m récup", type: "swim", detail: "Souple", xp: 35 },
