...
export const week6: TrainingWeekDefinition = {
  ...
  days: [
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "run-2", label: "Course — 10 km", type: "run", detail: "Allure régulière", xp: 50 },
    ...
    },
    {
      ...
      priority: "Normale",
      tasks: [
        { id: "swim-3", label: "Natation — 1700 m", type: "swim", detail: "Échauffement + technique", xp: 35 },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "run-4", label: "Course — 8 km fractionné", type: "run", detail: "40/20", xp: 50 },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "run-6", label: "Course — 15 km", type: "run", detail: "Allure confort", xp: 50 },
        { id: "swim-6", label: "Natation — 1300 m récup", type: "swim", detail: "Souple", xp: 35 },
