  ...
  days: [
    {
      ...
      tasks: [
        ...
        { id: "w6-mon-pull", label: "Tractions — 5×7", type: "pull", moment: "morning", detail: "Post-piscine", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w6-mon-chair", label: "Chaise — 3×140 s", type: "chair", moment: "morning", detail: "Renforcement musculaire", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w6-tue-pull", label: "Tractions — 5 séries réparties", type: "pull", moment: "morning", detail: "Matinée progressive", estimatedMinutes: 20, xp: 25, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w6-wed-pull", label: "Tractions — 5×7", type: "pull", moment: "morning", detail: "Renforcement", estimatedMinutes: 15, xp: 25, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w6-thu-pull", label: "Tractions — 5×7", type: "pull", moment: "morning", detail: "Renforcement", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w6-thu-chair", label: "Chaise — 3×140 s", type: "chair", moment: "morning", detail: "Stabilité", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w6-sat-pull", label: "Tractions — 5×7", type: "pull", moment: "afternoon", detail: "Post-sortie", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w6-sat-chair", label: "Chaise — 3×140 s", type: "chair", moment: "afternoon", detail: "Renforcement", estimatedMinutes: 10, xp: 15, completed: false },
        { id: "w6-sat-core", label: "Gainage — 15 min", type: "custom", moment: "afternoon", detail: "Stabilité", estimatedMinutes: 15, xp: 15, completed: false },
