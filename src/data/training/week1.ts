  ...
  days: [
    {
      ...
      tasks: [
        ...
        { id: "w1-mon-pull", label: "Tractions — 5×4", type: "pull", moment: "morning", detail: "Post-piscine", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w1-mon-chair", label: "Chaise — 3×60 s", type: "chair", moment: "morning", detail: "Renforcement musculaire", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w1-tue-pull", label: "Tractions — 5 séries réparties", type: "pull", moment: "morning", detail: "Matinée progressive", estimatedMinutes: 20, xp: 25, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w1-wed-pull", label: "Tractions — 5×4", type: "pull", moment: "morning", detail: "Renforcement", estimatedMinutes: 15, xp: 25, completed: false },
    ...
    },
    {
      ...
      priority: "Haute",
      tasks: [
        { id: "w1-thu-pull", label: "Tractions — 5×4", type: "pull", moment: "morning", detail: "Renforcement", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w1-thu-chair", label: "Chaise — 3×60 s", type: "chair", moment: "morning", detail: "Stabilité", estimatedMinutes: 10, xp: 15, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w1-fri-run", label: "Course en duo — footing récupération 4-5 km", type: "run", moment: "evening", detail: "Allure souple", estimatedMinutes: 35, xp: 50, completed: false },
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: "w1-sat-pull", label: "Tractions — 5×4", type: "pull", moment: "afternoon", detail: "Post-sortie", estimatedMinutes: 15, xp: 25, completed: false },
        { id: "w1-sat-chair", label: "Chaise — 3×60 s", type: "chair", moment: "afternoon", detail: "Renforcement", estimatedMinutes: 10, xp: 15, completed: false },
        { id: "w1-sat-core", label: "Gainage — 15 min", type: "custom", moment: "afternoon", detail: "Stabilité", estimatedMinutes: 15, xp: 15, completed: false },
