                        ...
                        <div className="space-y-2">
                          {normalized.map((w: any, idx: number) => {
                            ...
                            if (w.distanceMeters && w.distanceMeters > 0) {
                              distLabel = w.distanceMeters < 1000 ? `${w.distanceMeters}m` : `${(w.distanceMeters / 1000).toFixed(2)} km`;
                            } else if (w.distanceKm && w.distanceKm > 0) {
                              distLabel = w.distanceKm < 1 ? `${Math.round(w.distanceKm * 1000)}m` : `${w.distanceKm} km`;
                            }
